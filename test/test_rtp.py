...
@pytest.mark.parametrize(
    ('v_store,v_count,v_p_kf, v_n_kf,a_store,a_count,dur,parts'), [
        ('sonic-v.mjr', 9654, [
            ...
            ((True, (0, 1), 0, (0, 1))),
            ((True, (1, 463), 9.134000000000015, (1, 458))),
            ((True, (3, 251), 14.100000000000364, (3, 206))),
            ((True, (3, 251), 4.100000000000364, (3, 206))),
            ((True, (4, 622), 9.200000000000728, (4, 461))),
            ((True, (6, 313), 14.201000000000022, (6, 212))),
            ((True, (6, 313), 4.201000000000022, (6, 212))),
            ((True, (7, 932), 9.200000000000728, (7, 461))),
            ((True, (9, 404), 14.234000000000378, (9, 213))),
            ((True, (9, 404), 4.234000000000378, (9, 213))),
            ((True, (10, 3), 0.06700000000000728, (10, 5))),
            ((True, (11, 1070), 8.167000000000371, (11, 410))),
         ],
         'sonic-a.mjr', 5996,
         10.0, 12),
    ])
def test_cursor(
    ...
    assert sum(1 for _ in v_cur) == 0  # exhausted
    assert sum(1 for _ in a_cur) == a_count
    assert sum(1 for _ in a_cur) == 0  # exhausted
